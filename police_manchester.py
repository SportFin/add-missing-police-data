...
def fetch_crime_data(row):
    api_url = f"https://data.police.uk/api/crimes-street/all-crime?date=2023-04&lat={row['latitude']}&lng={row['longitude']}"
    try:
...
compiled_crime_df.to_csv("compiled_crime_data_04.csv", index=False)
